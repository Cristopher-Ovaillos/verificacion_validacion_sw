#copiado de Unidad_III/Ejercicio2/modelo/auto.py
#ademas tambien aplicamos los cambios esto incluye el Cambio A: limite 500→800 y bug >= corregido que ya venia de antes.
